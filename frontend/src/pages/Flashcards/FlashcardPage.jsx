...
// import { ChevronLeft, ChevronRight, RotateCw, Loader2, CheckCircle2 } from "lucide-react";
...
//         <p className="text-sm text-slate-300">No cards in this deck.</p>
//         <Link to="/flashcards" className="text-xs text-indigo-400 underline">
//           Back to all decks
//         </Link>
//       </div>
//     );
...
//   return (
//     <div className="p-8 max-w-xl mx-auto flex flex-col items-center gap-6">
//       <Link
//         to="/flashcards"
//         className="self-start flex items-center gap-1 text-xs text-slate-400 hover:text-slate-200"
//       >
...
//         className="w-full h-80 bg-slate-900 border border-slate-800 hover:border-emerald-500/40 rounded-3xl p-8 flex flex-col justify-between items-center text-center cursor-pointer shadow-2xl transition-all select-none"
//       >
//         <span className="text-xs uppercase tracking-wider font-bold text-emerald-400 bg-emerald-500/10 px-3 py-1 rounded-full">
//           {flipped ? "Answer" : "Question"}
//         </span>

//         <p className="text-base font-medium text-slate-100 leading-relaxed overflow-y-auto max-h-48 pr-1">
...
//             setIndex((i) => i - 1);
//           }}
//           className="p-3 bg-slate-900 border border-slate-800 rounded-full hover:bg-slate-800 disabled:opacity-30 transition"
//         >
