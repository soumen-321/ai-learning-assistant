...
//       {/* Top Header Bar */}
//       <header className="px-8 pt-6 pb-2 flex items-center justify-end gap-5">
//         <button
//           type="button"
...
//         {/* Welcome Section */}
//         <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-2">
...
//           {/* Uploaded Documents (Mint) */}
//           <div className="relative overflow-hidden bg-gradient-to-br from-[#E6F9F2] to-[#D5F5E9] border border-[#BFF0DE] rounded-3xl p-6 shadow-sm flex items-center gap-5">
//             <div className="w-14 h-14 rounded-2xl bg-[#00B884] text-white flex items-center justify-center shrink-0 shadow-md shadow-[#00B884]/20">
...
//           {/* Flashcard Decks (Periwinkle / Indigo) */}
//           <div className="relative overflow-hidden bg-gradient-to-br from-[#EEF2FF] to-[#E0E7FF] border border-[#C7D2FE] rounded-3xl p-6 shadow-sm flex items-center gap-5">
//             <div className="w-14 h-14 rounded-2xl bg-[#6366F1] text-white flex items-center justify-center shrink-0 shadow-md shadow-indigo-500/20">
...
//           {/* Quizzes Available (Peach / Amber) */}
//           <div className="relative overflow-hidden bg-gradient-to-br from-[#FFF7ED] to-[#FFEDD5] border border-[#FED7AA] rounded-3xl p-6 shadow-sm flex items-center gap-5">
//             <div className="w-14 h-14 rounded-2xl bg-[#F59E0B] text-white flex items-center justify-center shrink-0 shadow-md shadow-amber-500/20">
...
//         {/* Study a New Document Big Banner */}
//         <div className="relative overflow-hidden bg-gradient-to-r from-[#EBFBF5] via-[#E2F8EF] to-[#DEF7ED] border border-[#BFF0DE] rounded-3xl p-7 sm:p-9 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
